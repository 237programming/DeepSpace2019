...
public class DiskSecondLevel extends Command 
{
  ...
  {
    if(Robot.elevator.leftElevator.getSelectedSensorPosition(0) > -380000 && time < 0 && !m_step1Done)
    {
      Robot.elevator.elevatorUp();
    }
    else if(Robot.elevator.leftElevator.getSelectedSensorPosition(0) < -380000 && time < 0 && !m_step2Done)
    {
      m_step1Done = true;
